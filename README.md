...
FC is at version 1.0.0-rc.4. The compiler implements the features in the language specification, with 1250+ tests passing on gcc and clang across Linux and Windows (MSYS2/UCRT64). Breaking changes are still possible during the release-candidate phase as the surface settles.
