...
remain orthogonal. Any future move to add member access on type vars (or a user-extensible
constraint mechanism) should still reopen both this note and that one together.
