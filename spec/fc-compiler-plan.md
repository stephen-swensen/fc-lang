...
| **M10** | Polish: Full match exhaustiveness, closure escape detection, stack-slice return detection, integer literal range checking, static type properties (`int32.min`, `float64.nan`, etc.) | Full suite |
