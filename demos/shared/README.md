...
| `opl2.fc` | OPL2 / YM3812 FM chip emulator, incl. rhythm mode (`module opl2`) | `opl2_tables.fc`, `stdlib/math.fc` |
| `opl2_tables.fc` | The chip's precomputed lookup tables as frozen constants (`module opl2_tables`); generated by `tools/mk_opl2_tables.fc`, do not edit | — |
