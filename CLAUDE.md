...
- **stdlib feed:** the installed stdlib (`FCC_STDLIB_DIR`, else the baked-in `$(datadir)/fcc/stdlib`, else `./stdlib`) is merged into every analysis; diagnostics are filtered to the open file.
